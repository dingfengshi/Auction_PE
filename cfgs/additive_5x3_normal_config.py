...
__C.dir_name = os.path.join("experiments", "additive_5x3_normal")

# Auction params
__C.num_agents = 5
__C.num_items = 3
__C.distribution_type = "normal"
...
__C.test.restore_iter = 340000
# Number of misreports
__C.test.num_misreports = 120
# Number of steps for misreport computation
