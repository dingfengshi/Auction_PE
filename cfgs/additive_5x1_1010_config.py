...
__C.dir_name = os.path.join("experiments", "additive_5x1_1010")
...
__C.train.restore_iter = 7000
# max iters to train 
__C.train.max_iter = 7002
...
__C.val.num_batches = 60
# Frequency at which validation is performed
__C.val.print_iter = 40000
...
__C.test.restore_iter = 7000
# Number of misreports
__C.test.num_misreports = 400
# Number of steps for misreport computation
...
__C.test.num_batches = 173
# Test batch size
__C.test.batch_size = 29
# Save Ouput
