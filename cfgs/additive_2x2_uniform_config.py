...
__C.dir_name = os.path.join("experiments", "additive_2x2_uniform")
...
__C.val.num_batches = 40
# Frequency at which validation is performed
__C.val.print_iter = 50000
