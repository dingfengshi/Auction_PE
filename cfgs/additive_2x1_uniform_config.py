...
__C.dir_name = os.path.join("experiments", "additive_2x1_uniform")
...
__C.train.num_misreports = 30
# Number of steps for misreport computation
__C.train.gd_iter = 20
...
__C.train.save_iter = 1000
# Train stats print frequency
__C.train.print_iter = 2000
